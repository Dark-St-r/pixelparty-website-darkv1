...
const CancelModal = () => {
  ...
  async function offerFrame() {
    ...
    try {
      await NearUtils.cancelOffer(cancelModal.frameId);
    }
    catch (e) {
      ...
      setCancelModal({ showModal: false, frameId: -1 });
      ...
      <div className="fixed flex flex-row rounded-md shadow-xl bg-theme-normal">
        <div className="p-6">
          <span className="font-semibold text-gray-500 text-md ">
            Do you want to keep your frame and cancel the offering? <br />
            You need to wait a few seconds and refresh the page after you
            decided to keep your frame.
          </span>
